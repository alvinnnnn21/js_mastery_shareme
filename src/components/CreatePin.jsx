...
const CreatePin = ({user}) => {
    ...
    const savePin = () => {
        ...
        console.log(title  + " - " + about + " - " + destination);
                        ...
                        {!image ? (
                            <label>
                                <div className="flex flex-col items-center justify-center h-full">
                                    ...
                                    <p className="mt-32 text-gray-400">Use high-quality JPG, PNG, SVG less than 20 MB</p>
                                </div>
                                <input 
                                    type="file"
                                    name="upload-image"
                            ...
                            <div className="relative h-full">
                                <img src={image?.url} alt="uploaded-pic" className="w-full h-full"/>
                                <button
                                    type="button"
